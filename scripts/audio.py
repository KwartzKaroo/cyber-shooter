...
SFX = {
    ...
    'grinder': pygame.mixer.Sound('assets/audio/sfx/grinder.mp3'),
    ...
    'robot death 1': pygame.mixer.Sound('assets/audio/sfx/robot death 1.mp3'),
    'robot death 2': pygame.mixer.Sound('assets/audio/sfx/robot death 2.mp3'),
    'robot hurt': pygame.mixer.Sound('assets/audio/sfx/robot hurt.mp3'),

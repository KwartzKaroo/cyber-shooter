...
from scripts.utils import CustomButton, load_all_images, debug_info, Animation, debug_rect, Timer
...
class Editor:
    def __init__(self):
        ...
        self.gun_offsets = {}
        self.gun_type = 1
        self.gun_names = ('01', '02', '03', '04', '05', '06', '07', '08', '09', '10',
                          '11', '12', '13', '14')
        self.gun_index = 0

        # Buttons
        self.buttons = {
            'biker': CustomButton((160, 48), 'Biker', bd_width=4),
            'punk': CustomButton((160, 48), 'Punk', bd_width=4),
            'cyborg': CustomButton((160, 48), 'Cyborg', bd_width=4),
            'offsets': CustomButton((160, 48), 'Offsets', bd_width=4),
            'next': CustomButton((40, 40), '>', bd_width=4),
            'prev': CustomButton((40, 40), '<', bd_width=4),
            'left': CustomButton((40, 40), '←', bd_width=4),
            'right': CustomButton((40, 40), '→', bd_width=4),
            'up': CustomButton((40, 40), '↑', bd_width=4),
            'down': CustomButton((40, 40), '↓', bd_width=4),
            'save': CustomButton((160, 48), 'Save', bd_width=4),
            'type1': CustomButton((128, 48), 'Type: 1', bd_width=4),
            'type2': CustomButton((128, 48), 'Type: 2', bd_width=4),
            'guns': CustomButton((128, 48), 'Guns', bd_width=4),
            'hands': CustomButton((128, 48), 'Hands', bd_width=4),
            'auto_on': CustomButton((128, 48), 'Auto: On', bd_width=4),
            'auto_off': CustomButton((128, 48), 'Auto: Off', font_size=26, bd_width=4),
        }
    ...
    def draw(self):
        ...
        gun_offsets = self.gun_offsets[self.gun_names[self.gun_index]][self.hand_index]
    ...
    def edit(self):
        ...
        if self.edit_hands:
            ...
            offset = self.gun_offsets[self.gun_names[self.gun_index]][self.hand_index]
    ...
    def hud(self):
        ...
        if self.edit_hands:
            ...
            debug_info(self.screen, self.gun_names[self.gun_index], (150, 48),
                       True, size=32, bg_colour='#43b0f0')
            self.buttons['left'].draw(self.screen, (48, 48))
            if self.buttons['left'].click(self.mouse_rect, click):
                self.gun_index = (self.gun_index - 1) % 14
    ...
    def load_images(self):
        ...
        self.hand_images = {
            1: load_all_images(f'assets/sprites/guns/hands/{self.character}/1'),
            2: load_all_images(f'assets/sprites/guns/hands/{self.character}/2'),
        }
